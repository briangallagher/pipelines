...
def tabnet_hyperparameter_tuning_job(
    project: str,
    location: str,
    root_dir: str,
    target_column: str,
      ...
      args=[
          ...
          dsl.ConcatPlaceholder(
              items=[
                  (
                      '{"display_name":'
                      f' "tabnet-hyperparameter-tuning-job-{dsl.PIPELINE_JOB_ID_PLACEHOLDER}-{dsl.PIPELINE_TASK_ID_PLACEHOLDER}",'
                  ...
                  'us-docker.pkg.dev/vertex-ai-restricted/automl-tabular/tabnet-training:20250729_0525',
                  '", "args": ["--target_column=',
                  target_column,
                  '", "--weight_column=',
                  weight_column,
                  ...
                  'us-docker.pkg.dev/vertex-ai/automl-tabular/prediction-server:20250729_0525',
