      ...
      args=[
          ...
          dsl.ConcatPlaceholder(
              items=[
                  ...
                  (
                      '"container_spec":'
                      ' {"image_uri":"us-docker.pkg.dev/vertex-ai-restricted/automl-tabular/training:20250729_0525", '
                  ),
                  ...
                  (
                      '--dataflow_worker_container_image=us-docker.pkg.dev/vertex-ai/automl-tabular/dataflow-worker:20250729_0525", "'
                  ),
                  (
                      '--prediction_container_image=us-docker.pkg.dev/vertex-ai/automl-tabular/fte-prediction-server:20250729_0525", "'
                  ),
                  '--artifacts_dir=',
                  root_dir,
