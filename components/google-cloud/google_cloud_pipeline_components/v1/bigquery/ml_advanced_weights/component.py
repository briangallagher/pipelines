...
def bigquery_ml_advanced_weights_job(
  ...
  Args:
      ...
      model: BigQuery ML model for ml advanced weights job.  For more details, see https://cloud.google.com/bigquery-ml/docs/reference/standard-sql/bigqueryml-syntax-predict#predict_model_name
      ...
      project: Project to run BigQuery ml advanced weights job. Defaults to the project in which the PipelineJob is run.

  Returns:
      weights: Describes different output columns for different models. For more details, see https://cloud.google.com/bigquery-ml/docs/reference/standard-sql/bigqueryml-syntax-advanced-weights#mladvanced_weights_output.
  ...
  return ContainerSpec(
      ...
      command=[
          ...
          '-u',
          '-m',
          'google_cloud_pipeline_components.container.v1.bigquery.ml_advanced_weights.launcher',
      ],
      args=[
          '--type',
