...
def bigquery_ml_training_info_job(
  ...
  Args:
      ...
      project: Project to run BigQuery ML training info job. Defaults to the project in which the PipelineJob is run.

  Returns:
      ml_training_info: Describes common metrics applicable to the type of model supplied. For more details, see https://cloud.google.com/bigquery-ml/docs/reference/standard-sql/bigqueryml-syntax-evaluate#mlevaluate_output
