...
@container_component
def dataproc_create_spark_r_batch(
  ...
  Args:
      ...
      main_r_file_uri: The HCFS URI of the main R file to use as the driver. Must be a `.R` or `.r` file.
  ...
  return ContainerSpec(
      ...
      command=[
          ...
          '-u',
          '-m',
          'google_cloud_pipeline_components.container.v1.dataproc.create_spark_r_batch.launcher',
      ],
      args=[
          '--type',
          'DataprocSparkRBatch',
