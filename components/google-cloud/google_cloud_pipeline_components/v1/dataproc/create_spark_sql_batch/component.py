...
def dataproc_create_spark_sql_batch(
  ...
  Args:
      ...
      query_file_uri: The HCFS URI of the script that contains Spark SQL queries to execute.
      query_variables: Mapping of query variable names to values (equivalent to the Spark SQL command: `SET name="value";`). An object containing a list of `"key": value` pairs. Example: `{ "name": "wrench", "mass": "1.3kg", "count": "3" }`.
