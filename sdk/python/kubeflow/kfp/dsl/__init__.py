...
from kubeflow.kfp.dsl.task_final_status import PipelineTaskFinalStatus
from kubeflow.kfp.dsl.types.artifact_types import Artifact
from kubeflow.kfp.dsl.types.artifact_types import ClassificationMetrics
from kubeflow.kfp.dsl.types.artifact_types import Dataset
from kubeflow.kfp.dsl.types.artifact_types import get_uri
from kubeflow.kfp.dsl.types.artifact_types import HTML
from kubeflow.kfp.dsl.types.artifact_types import Markdown
from kubeflow.kfp.dsl.types.artifact_types import Metrics
from kubeflow.kfp.dsl.types.artifact_types import Model
from kubeflow.kfp.dsl.types.artifact_types import SlicedClassificationMetrics
from kubeflow.kfp.dsl.types.type_annotations import InputAnnotation
from kubeflow.kfp.dsl.types.type_annotations import InputPath
from kubeflow.kfp.dsl.types.type_annotations import OutputAnnotation
from kubeflow.kfp.dsl.types.type_annotations import OutputPath
...
if os.environ.get('_KFP_RUNTIME', 'false') != 'true':
    from kubeflow.kfp.dsl.component_decorator import component
    from kubeflow.kfp.dsl.container_component_decorator import container_component
    # TODO: Collected should be moved to pipeline_channel.py, consistent with OneOf
    from kubeflow.kfp.dsl.for_loop import Collected
    from kubeflow.kfp.dsl.importer_node import importer
    from kubeflow.kfp.dsl.pipeline_channel import OneOf
    from kubeflow.kfp.dsl.pipeline_config import KubernetesWorkspaceConfig
    from kubeflow.kfp.dsl.pipeline_config import PipelineConfig
    from kubeflow.kfp.dsl.pipeline_config import WorkspaceConfig
    from kubeflow.kfp.dsl.pipeline_context import pipeline
    from kubeflow.kfp.dsl.pipeline_task import PipelineTask
    from kubeflow.kfp.dsl.placeholders import ConcatPlaceholder
    from kubeflow.kfp.dsl.placeholders import IfPresentPlaceholder
    from kubeflow.kfp.dsl.structures import ContainerSpec
    from kubeflow.kfp.dsl.tasks_group import Condition
    from kubeflow.kfp.dsl.tasks_group import Elif
    from kubeflow.kfp.dsl.tasks_group import Else
    from kubeflow.kfp.dsl.tasks_group import ExitHandler
    from kubeflow.kfp.dsl.tasks_group import If
    from kubeflow.kfp.dsl.tasks_group import ParallelFor
    __all__.extend([
