...
from kubeflow.kfp.dsl import v1_structures
from kubeflow.kfp.dsl.container_component_artifact_channel import \
    ContainerComponentArtifactChannel
from kubeflow.kfp.dsl.types import artifact_types
from kubeflow.kfp.dsl.types import type_annotations
...
class ComponentSpec:
    ...
    def from_ir_dicts(
        ...
        def extract_description_from_command(
            ...
            for command in commands:
                if isinstance(command, str) and 'import kubeflow.kfp' in command:
    ...
    def save_to_component_yaml(self, output_file: str) -> None:
        ...
        """
        from kubeflow.kfp.compiler import pipeline_spec_builder as builder
    ...
    def to_pipeline_spec(self) -> pipeline_spec_pb2.PipelineSpec:
        ...
        from kubeflow.kfp.compiler import pipeline_spec_builder as builder
        from kubeflow.kfp.dsl import pipeline_channel
