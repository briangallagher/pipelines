...
from kubeflow.kfp.local import testing_utilities
import pytest
...
class TestUseCurrentPythonExecutable(
    ...
    def test(self):
        full_command = ['python3 -c "from kubeflow.kfp import dsl"']
        actual = subprocess_task_handler.replace_python_executable(
            full_command=full_command,
            new_executable='/foo/bar/python3',
        )
        expected = ['/foo/bar/python3 -c "from kubeflow.kfp import dsl"']
